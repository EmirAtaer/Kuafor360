...
npm run start
```
Ardından tarayıcınızda [http://localhost:5050](http://localhost:5050) adresini açarak müşteriye dönük arayüzü ve API'yi aynı origin üzerinden görüntüleyebilirsiniz.
